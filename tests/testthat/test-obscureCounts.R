test_that("check for incidence", {
  inc <- tibble::tibble(
    ...
    ir_100000_pys_95CI_lower = c(0.1, 20, 50),
    ir_100000_pys_95CI_upper = c(10, 30, 50)
  )
  ...
  expect_true(!is.na(inc$ir_100000_pys_95CI_lower[3]))
  expect_true(!is.na(inc$ir_100000_pys_95CI_upper[3]))
})
