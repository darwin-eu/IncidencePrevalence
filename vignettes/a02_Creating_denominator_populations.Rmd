...
In the case below we can see that person "5" satisfies the age requirement after their strata cohort start date. Therefore, this individual is included when strataRequirementsAtEntry is FALSE (contributing once they reach the age of 15), but are excuded strataRequirementsAtEntry is TRUE (as they were not 15 on their strata cohort start date).  
