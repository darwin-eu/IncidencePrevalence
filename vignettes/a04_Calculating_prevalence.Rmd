...
In addition, we can identify the individuals who contributed to the prevalence rate analysis by using `participants(), along with the start and end date of their contribution. 
```{r, message= FALSE, warning=FALSE}
participants(prev)
```
