...
prev2 <- computePrevalence(
  cdm = cdm2,
  denominatorTable = "denominator",
  outcomeTable = "outcome",
  outcomeId = "1",
  denominatorId = c("1", "2", "3", "4", "5", "6"),
  interval = "months",
  type = "period",
  minCellCount = 0
)
