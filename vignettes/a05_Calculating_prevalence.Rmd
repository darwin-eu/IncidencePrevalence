...
```{r, message= FALSE, warning=FALSE}
cdm2 <- generate_mock_incidence_prevalence_db(sample_size=500000,
                                           out_pre=0.5,
                                           age_beta = 5,
                                           gender_beta = 2,
                                           intercept = -1,
...
dpop2 <- collectDenominatorPops(cdm = cdm2,
                                  startDate = as.Date("2008-01-01"),
                                  endDate = as.Date("2016-01-01"),
                                  ageStrata = list(c(0,39),
                                                           c(40,59),
                                                           c(60,150)),
...
prev2 <- collectPopPrevalence(    
  cdm = cdm2,
  denominatorTable = "denominator",
  outcomesTable = "outcome",
  outcomeCohortIds = "1",
  denominatorCohortIds = c("1", "2", "3","4","5","6"),
  interval="months",
  type = "period",
  minCellCount = 0
)
