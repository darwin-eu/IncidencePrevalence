...
cdm_ref$denominator <- dpop$denominator_population
...
```{r, message= FALSE, warning=FALSE}
cdm_ref2 <- generate_mock_incidence_prevalence_db(sample_size=500000,
                                           out_pre=0.5,
                                           age_beta = 5,
                                           gender_beta = 2,
                                           intercept = -1,
...
print(nrow(dplyr::tbl(attr(cdm_ref2, 'dbcon'), "person") %>% collect()))
print(nrow(dplyr::tbl(attr(cdm_ref2, 'dbcon'), "outcome") %>% collect()))

dpop2 <- collect_denominator_pops(cdm_ref = cdm_ref2,
                                  study_start_date = as.Date("2008-01-01"),
...
cdm_ref2$denominator<-dpop2$denominator_populations
